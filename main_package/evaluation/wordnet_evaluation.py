...
dialogues = [["In the past , you ve forgotten one thing .","That s one of them eventually ."],
["Was he the one who made me go on the details .","It 's one thing ."],
["We ll talk when I get to the same point in time , that this one doesn t have them .","Anesthesiologists , one by the cardiac bypass machine , one by the cardiac bypass machine , one by the cooling apparatus ."],
["And this is a good time ?","But this time , do it in a hospital ."],
["Heard you the first time , and a whole lot of what has Smoot done lately ?","Actually , this stuff is the first time through this place ."]]

for sent_pair in dialogues:
    print("%s\t%s\t%.3f\t%.3f" % (sent_pair[0], sent_pair[1],
                                  similarity(sent_pair[0], sent_pair[1], False),
                                  similarity(sent_pair[0], sent_pair[1], True)))